insert into user(id, first_name, last_name, email, created, modified) values
(1, "Anna", "Jenkins", "annajenkins@email.com", "2023-01-01 12:00:00", "2023-01-01 12:00:00"),
(2, "John", "Smith", "johnsmith@email.com", "2023-01-01 12:00:00", "2023-01-01 12:00:00");

insert into account(id, balance, user_id, created, modified) values
(1, 100.00, 1, "2023-01-01 12:00:00", "2023-01-01 12:00:00"),
(2, 100.00, 2, "2023-01-01 12:00:00", "2023-01-01 12:00:00");

INSERT INTO `currency` (`country`, `name`, `code`, `number`) VALUES
